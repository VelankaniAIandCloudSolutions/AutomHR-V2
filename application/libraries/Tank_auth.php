...
class Tank_auth
{
	...
	*/
	...
	function admin_create_user($username, $email, $password, $fullname, $company, $city, $state, $address, $pincode, $role, $user_type, $phone, $doj, $email_activation,$designation_id,$department_id,$is_teamlead,$ro,$branch_id,$is_reporter)
	{
