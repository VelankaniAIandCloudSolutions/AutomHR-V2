...
$this->db->select('U.id,AD.fullname as username,U.email,U.created,C.company_name, AD.address');
...
$company_logo = config_item('company_logo');
...
if(!empty($user_det)){
	...
	$pdf->Image('assets/images/'.$company_logo,80,4,0,10); 
