<div class="content container-fluid">
          <div class="row">
            <div class="col-xs-8">
              <h4 class="page-title">Budget Expenses</h4>
            </div>

            <div class="col-xs-4 text-right m-b-30">
             
              
      <a href="<?=base_url()?>budget_expenses/create" data-toggle="ajaxModal" title="<?=lang('create_expense')?>" class="btn btn-primary rounded pull-right"><i class="fa fa-plus"></i> <?=lang('create_expense')?></a>
     
            </div>
          </div>
          <div class="row filter-row">
              <div class="col-md-12 padding-2p search_date">
            <form id="timesheet_search" method="post" action="<?php echo base_url().'budget_expenses/'; ?>">
                  <div class="row">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="table-responsive">
                <table class="table table-striped custom-table datatable" id="table-budget-expense">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Notes</th>                    
                        ...
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                              <li><a href="<?php echo base_url(); ?>budget_expenses/edit/<?php echo $budget['id']; ?>" data-toggle="ajaxModal"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
                 ...
                 <?php /*foreach($budget_expenses as $budget){ ?>
                    <div id="delete_budget<?php echo $budget['id']; ?>" class="modal custom-modal fade" role="dialog">
                      <div class="modal-dialog">
                        <div class="modal-content modal-md">
                          <div class="modal-header">
                            <h4 class="modal-title">Delete Expenses( <?php echo $budget['notes']; ?> )</h4>
                          </div>
                          <form method="post" action="<?php echo base_url(); ?>budget_expenses/delete_budget/<?php echo $budget['id']; ?>">
...
<script>
    ...
    var expenses_date_from  = $('#expenses_date_from').val();
    var expenses_date_to  = $('#expenses_date_to').val();
		$('#table-budget-expense').DataTable( {
		"columns": [
				{ data: "budget_no" },
				{ data: "notes" },
				{ data: "category" },
    ...
    "searching":false,
		...
		"ajax": "<?php echo base_url().'budget_expenses/ajax_budget_expense';?>?cat_id="+cat_id+"&expenses_date_from="+expenses_date_from+"&expenses_date_to"+expenses_date_to
		} );
	} );
</script>