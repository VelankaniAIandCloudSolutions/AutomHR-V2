<div class="header-white header">
	...
	<ul class="navbar-nav navbar-right nav-user float-right flex-row user-menu justify-content-end">
		...
		<li class="nav-item">
			<a class="nav-link" href="<?php echo base_url('candidates'); ?>" >
			<span>Candidate <?php echo lang('login');?></span>
			</a>
		</li>
		<li class=" nav-item">
			<a class="nav-link" href="<?php echo base_url('login'); ?>" >
			<span>Admin <?php echo lang('login');?></span>
			</a>
		</li>
	</ul>
</div>
<?php $all_job_header= $this->db->get('all_job_header')->row_array(); 
if(!empty($all_job_header['image'])){
?>
	<div class="container-fluid p-0" style="width:100%;">
		<div class="top-image">
			<img src="<?php echo base_url();?>/assets/uploads/<?php echo $all_job_header['image']?>" class="img-fluid" alt="Responsive image" style="width:100%;height:300px;">
		</div> 
	</div>
<?php } ?>
...
<form action="<?php echo site_url('candidates/all_jobs_user');?>" method="post" id="search_user_filter">
	...
	<div class="row filter-row">
		...
		<div class="col-sm-6 col-12 col-md-3">  
			...
			<div class="text-right"><a href="#" data-toggle="collapse" data-target="#advance_search" class="text-white badge bg-info" style="display:inline-block; padding:5px 10px;"><?php echo lang('advanced_search');?></a>
			<a style="display:inline-block;padding:5px 10px;" class="badge bg-danger text-white" href="<?php echo site_url('candidates/all_jobs_user');?>"><?php echo lang('clear');?></a>
		</div>
		</div>  
	</div>
			...
			<a class="job-list" href="<?php echo base_url(); ?>candidates/job_view_user/<?php echo $list->id;?>">
				<div class="job-list-det">
					<div class="job-list-desc">
						<h3 class="job-list-title text-capitalize"><?php echo $list->job_title;?></h3>
