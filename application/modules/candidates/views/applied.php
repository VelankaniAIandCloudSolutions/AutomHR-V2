...
<div class="content p-t-10">
	...
	<div class="row">
		<div class="col-12">
			<h4 class="page-title"><?php echo lang('applied_jobs');?></h4>
			 <ul class="breadcrumb p-l-0" style="background:none; border:none;">
				...
				<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>jobs/dashboard">Recruiting Process</a></li>
				 <li class="breadcrumb-item"><?php echo lang('applied_jobs');?></li>
	...
	<div class="card-box">
		<form action="<?php echo site_url('candidates/applied');?>" method="post" id="applied_list_filter">
	<div class="row filter-row">
		...
		<div class="col-sm-6 col-6 col-md-3">  
			...
			<a class="badge bg-danger text-white" href="<?php echo site_url('candidates/applied'); ?>">Clear</a>  
		</div>  
	</div>
	</form>
</div>
					 ...
					 foreach($applied_jobs as $key=>$list){
						...
						<td class="text-center">
							<div class="action-label">
								...
								elseif($list->user_job_status==9){echo lang('offer_declined');}
								elseif($list->user_job_status==10){echo lang('offer_rejected');}
