				...
				<div class='form-group'>
					...
					<div class="col-lg-8">
						<select name="type" id='type' class="form-control m-b" required>
							<option value="" <?php if($inf->type =="" || $inf->type == NULL){echo"selected";}?> > Select Type </option>
							<option value="1" <?php if($inf->type == "1"){echo"selected";}?> > Advance </option>
							<option value="2" <?php if($inf->type == "2"){echo"selected";}?>> Expenses </option>
							<option value="3" <?php if($inf->type == "3"){echo"selected";}?>> Reimbursement </option>
						</select>
					</div>
				</div>
