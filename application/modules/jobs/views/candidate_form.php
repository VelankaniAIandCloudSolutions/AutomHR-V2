...
<div class="content">
	...
	<div class="tab-content">
		<!-- Profile Info Tab -->
		<div id="emp_profile" class="pro-overview tab-pane show active">
			<form name="contact_info" action="<?php echo site_url('jobs/add_candidates'); ?>" id="contact_info_add" method="post" enctype="multipart/form-data">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="card-box profile-box">
							<h3 class="card-title"><?php echo lang('contact_informations'); ?></h3>
							<div class="form-group">
								<label class="col-form-label"><?php echo lang('first_name'); ?><span class="text-danger">*</span></label>
								<input type="text" class="form-control" placeholder="N/A" name="first_name" value="<?php if (isset($candidate_detail['first_name'])) {
																														echo $candidate_detail['first_name'];
																													} ?>" required>
							</div>
							<div class="form-group">
								<label class="col-form-label"><?php echo lang('last_name'); ?> <span class="text-danger">*</span></label>
								<input type="text" class="form-control" placeholder="N/A" name="last_name" value="<?php if (isset($candidate_detail['last_name'])) {
																														echo $candidate_detail['last_name'];
																													} ?>">
							</div>
							<div class="form-group">
								<label class="col-form-label"><?php echo lang('address'); ?> <span class="text-danger">*</span></label>
								<input type="text" class="form-control" placeholder="N/A" name="address" value="<?php if (isset($candidate_detail['address'])) {
																													echo $candidate_detail['address'];
																												} ?>">
							</div>
							<div class="form-group">
								<label class="col-form-label"><?php echo lang('country'); ?> <span class="text-danger">*</span></label>
								<input type="text" class="form-control" name="country" value="<?php if (isset($candidate_detail['country'])) {
																									echo $candidate_detail['country'];
																								} ?>" required>
							</div>
							<div class="form-group">
								<label class="col-form-label"><?php echo lang('state'); ?> <span class="text-danger">*</span></label>
								<input type="text" class="form-control" name="state" value="<?php if (isset($candidate_detail['state'])) {
																								echo $candidate_detail['state'];
																							} ?>" required>
							</div>
							<div class="form-group">
								<label class="col-form-label"><?php echo lang('city'); ?></label>
								<input type="text" class="form-control" placeholder="N/A" name="city" value="<?php if (isset($candidate_detail['city'])) {
																													echo $candidate_detail['city'];
																												} ?>" required>
							</div>
							<div class="form-group">
								<label class="col-form-label"><?php echo lang('zip_postal_code'); ?></label>
								<input type="text" class="form-control" placeholder="N/A" name="pincode" value="<?php if (isset($candidate_detail['pincode'])) {
																													echo $candidate_detail['pincode'];
																												} ?>" required>
							</div>
							<div class="form-group">
								<label class="col-form-label"><?php echo lang('phone'); ?></label>
								<input type="text" class="form-control" placeholder="N/A" name="phone_number" value="<?php if (isset($candidate_detail['phone_number'])) {
																															echo $candidate_detail['phone_number'];
																														} ?>" required>
							</div>
							<div class="form-group">
								<label class="col-form-label"><?php echo lang('web_address'); ?>?</label>
								<input type="text" class="form-control" placeholder="N/A" name="web_address" value="<?php if (isset($candidate_detail['web_address'])) {
																														echo $candidate_detail['web_address'];
																													} ?>">
							</div>
							<div class="form-group">
								<label class="col-form-label"><?php echo lang('email'); ?> <span class="text-danger">*</span></label>
								<input type="email" class="form-control" placeholder="N/A" name="email" required value="<?php if (isset($candidate_detail['email'])) {
																															echo $candidate_detail['email'];
																														} ?>">
							</div>
							<div class="form-group">
								...
								<select class="select required" name="job_category[0]" id="job_category" required onchange="position_types(this.value);">
									...
									?>
										<option value="<?php echo $depart->deptid; ?>" <?php if (in_array($depart->deptid, $dept_array)) {
																							echo "selected";
																						} ?>><?php echo $depart->deptname; ?></option>
									<?php
									}
									?>
								</select>
							...
							<div class="form-group">
								...
								<select class="form-control" name="position_type[0]" id="position_type" required>
									...
									?>
											<option value="<?php echo $des['id']; ?>" <?php if (in_array($des['id'], $position_array)) {
																							echo "selected";
																						} ?>><?php echo $des['designation']; ?></option>
									<?php
										}
									} ?>
								</select>
							...
							<div class="form-group">
								...
								<div class="input-group input-file" name="resume">
									<input type="file" name="resume_file" class="form-control" placeholder='Choose a file...' <?php if (!$this->uri->segment(3)) {
																																	echo "required";
																																} ?> />
								</div>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="N/A" name="password" <?php if (!$this->uri->segment(3)) {
																												echo "required";
																											} ?> value="">
							</div>
						</div>
					...
					<div class="col-md-6">
						<div class="card-box profile-box">
							<h3 class="card-title"><?php echo lang('education_history'); ?></h3>
							<h5 class="section-title"><a href="#addEducation" data-toggle="collapse"><?php echo lang('add_education') ?></a></h5>
							<div id="addEducation" class="collapse <?php if (isset($candidate_detail['school_name']) && $candidate_detail['school_name'] != "") {
																		echo 'in';
																	} ?>">
								<div class="form-group">
									<label class="col-form-label"><?php echo lang('school_name') ?> </label>
									<input type="text" class="form-control" placeholder="N/A" name="school_name" value="<?php if (isset($candidate_detail['school_name'])) {
																															echo $candidate_detail['school_name'];
																														} ?>">
								</div>
								<div class="form-group">
									<label class="col-form-label"><?php echo lang('graduation_year'); ?> </label>
									<input type="text" class="form-control" placeholder="N/A" name="passed_out_year" value="<?php if (isset($candidate_detail['passed_out_year'])) {
																																echo $candidate_detail['passed_out_year'];
																															} ?>">
								</div>
								<div class="form-group">
									<label class="col-form-label"><?php echo lang('major_area_of_study') ?> </label>
									<input type="text" class="form-control" placeholder="N/A" name="major_subject" value="<?php if (isset($candidate_detail['major_subject'])) {
																																echo $candidate_detail['major_subject'];
																															} ?>">
								</div>
								<div class="form-group">
									<label class="col-form-label"><?php echo lang('degree'); ?> </label>
									<input type="text" class="form-control" placeholder="N/A" name="degree" value="<?php if (isset($candidate_detail['degree'])) {
																														echo $candidate_detail['degree'];
																													} ?>">
								</div>
								<div class="form-group">
									<label class="col-form-label"><?php echo lang('gpa'); ?> </label>
									<input type="text" class="form-control" placeholder="N/A" value="<?php if (isset($candidate_detail['gpa'])) {
																											echo $candidate_detail['gpa'];
																										} ?>" name="gpa">
								</div>
							</div>
						</div>
					...
					<div class="col-md-6">
						<div class="card-box profile-box">
							<h3 class="card-title"><?php echo lang('skills'); ?></h3>
							<h5 class="section-title"><a href="#addEducation2" data-toggle="collapse"><?php echo lang('add_skills'); ?></a></h5>
							<div id="addEducation2" class="collapse <?php if (isset($candidate_detail['skills']) &&  $candidate_detail['skills'] != "") {
																		echo 'in';
																	} ?>">
								<div class="form-group">
									<label class="col-form-label"><?php echo lang('resposibilities'); ?> </label>
									<textarea class="form-control" name="skills" row="5"><?php if (isset($candidate_detail['skills'])) {
																								echo trim($candidate_detail['skills']);
																							} ?></textarea>
								</div>
							</div>
						</div>
				...
				<div class="row card-box profile-box">
					<div class="col-md-12 addtional">
						<h3 class="card-title"><?php echo lang('ctc_addition'); ?> </h3>
						<table class="table table-hover table-radius">
							...
							<tbody>
								<?php
								$all_addtional = $this->db->get_where('dgt_candidate_ctc', array('candidate_id' => $candidate_detail['id']))->row_array();
								$addtional_ar = json_decode($all_addtional['addtional'], TRUE);
								$i = 1;
					...
					<div class="col-md-12 deduction">
						<h3 class="card-title"><?php echo lang('ctc_deduction'); ?> </h3>
						<table class="table table-hover table-radius">
							<thead>
								<tr>
									<th>#</th>
							...
							<tbody>
								...
								$deduction_ar = json_decode($all_addtional['deduction'], TRUE);
								$i = 1;
