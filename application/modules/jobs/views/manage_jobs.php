...
<div class="content">
	...
	<div class="row">
		...
		<div class="col-md-8 col-12 text-right m-b-30">
				...
				<a class="btn add-btn m-r-5" href="<?php echo base_url(); ?>jobs/pending_for_job_post_list" class="btn add-btn"><i class="fa fa-list"></i> <?php echo lang('pending_for_job_post_list');?></a>
