...
class Jobs extends MX_Controller
{
    ...
    function user_status_change()
    {
      ...
      $ins_data['user_id'] = $this->session->userdata('user_id');
      $ins_data['candidate'] = $user_id;
      $ins_data['title'] = $where['job_id'];

      $job_data = $this->Jobs_model->select_row_array('jobs',array('id'=>$ins_data['title']));
      $ins_data['job_type'] = $job_data['job_type_id'];
      $ins_data['salary'] = $job_data['salary_from'];
