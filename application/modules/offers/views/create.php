...
<!-- Content -->
									...
									<div class="col-md-12">
										<form class="form-horizontal" id="create_offers" action="<?=base_url()?>offers/create" method="POST">
											...
											<div class="form-group form-row">
												...
												<div class="col-sm-9">
													<?php /*<input class="form-control" type="text" name="candidate" id="check_candidate">*/?>
													<select class="form-control"  id="check_candidate" name="candidate" onchange="get_job(this.value)">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select class="select2-option12 form-control"   style="width:100%" name="title" id="job_title" onchange="job_detail(this.value)"> 
											...
											<div class="form-group">
												<label class="control-label col-sm-3"><?php echo lang("report_to")?></label>
												<div class="col-sm-9">
													<select class="form-control select2-option" name="reports_to"  id="reports_to" required >
													<option value=''>Reporting Manager</option>	
													<?php foreach (User::getEmployees() as $jtype =>$jvalue): ?>
															<option value="<?=$jvalue['id']?>"  >
																<?= ucfirst(trim($jvalue['fullname'].' ('.$jvalue['emp_code'].')'));?>
															</option>
														<?php endforeach ?>	
													</select>
												</div>
											...
											<div class="form-group">
												<label class="control-label col-sm-3"><?php echo lang("join_date");?></label>
												<div class="col-sm-9">
													<input class="form-control" type="date" name="date_of_joining" id="date_of_joining" required />
												</div>
											</div>

											<div class="form-group">
												<label class="control-label col-sm-3"><?php echo lang("hr")?></label>
												<div class="col-sm-9">
													<select class="form-control select2-option" name="hr_manager_id"  id="hr_manager_id" required >
														<option value=''>Select HR</option>
														<?php foreach (User::getEmployeesHrList() as $jtype =>$jvalue): ?>
															<option value="<?=$jvalue['id']?>"  >
																<?= ucfirst(trim($jvalue['fullname'].' ('.$jvalue['emp_code'].')'));?>
															</option>
														<?php endforeach ?>	
				...
				function get_job(a){
					$.ajax({
						type: "POST",
						url: "offers/getJobs_by_candidate",
						data:{candidate_id:a}, 
						beforeSend :function(){
