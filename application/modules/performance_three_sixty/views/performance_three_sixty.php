...
$performance_competency = $this->db->order_by('competency','ASC')->get('performance_competency')->result_array();
...
$dgt_competencies_rating = $this->db
    ->select('*')
    ->from('dgt_competencies')
    ->where(array("YEAR(created_by)" => $year, "user_id" => $employee_id))
    ->group_by("competencies")
    ->order_by("id", "desc")
    ->get()
    ->result_array();


$self_rating = $rating = 'disable';
$manager_total_rating = $mangaer_rating_avg = 0;
if(!empty($dgt_competencies_rating))
{
    $self_rating= 'disable';

     $manager_rating = array_column($dgt_competencies_rating, 'rating');

     $manager_total_rating = array_sum($manager_rating);
     $mangaer_rating_avg = round(($manager_total_rating / count($dgt_competencies_rating)), 2);
}
...
<div class="content container-fluid">
    <div class="row">
        <div class="col-sm-8">
            <h4 class="page-title m-b-5">Self Assestment</h4>
...
<div class="col-sm-8">
    <div class="join-year">
        ...
        <?php echo base_url('performance_three_sixty')?>">
        <div class="row">
            <div class="col-md-8">
...
<div class="performance-wrap"> <?php if(!empty($performances_360)){ 
    ...
    $count =1 ; ?> </div> <?php } ?> <div class="performance-wrap">
        ...
        <div class="performance-box comp-box m-b-0">
            ...
            <form name="competency_form" id="competency_form" method="post" action="<?php echo base_url('performance_three_sixty/create_competencies');?>">
            ...
            <div class="table-responsive">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 10%;">Manager Rating</th>
                        ...
                        <tbody> <?php if(! empty($performance_competency)){ 
                            ...
                            ?> <tr>
                                ...
                                <td style="width: 20%;">
                                    <strong><?php echo $performance_competencies['competency'];?></strong>
                                    <div style="width: 300px; height: 50px; overflow: auto; word-wrap: break-word;">
                                    <?php echo $performance_competencies['definition']; ?>
                                </div>
                                ...
                                <td style="width: 10%;">
                                    <select class="form-control select " name="self_rating[]" required >
                                        ...
                                        <option value="">Not rated</option> <?php if(isset($ratings) && !empty($ratings)){                                                          
                                            ...
                                            for ($i=0; $i 
                                                ...
                                                $feedback=$this->db->where('competencies',$performance_competencies['id'])->where('user_id',$employee_details['id'])->where('YEAR(created_by)', trim($year))->
                                                get('dgt_competencies')->row_array();
                                                 ?> 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Total Score of Manager Rating</label>
                                    <input type="text" class='form-control' name="score_manager_rating" value="<?php echo $mangaer_rating_avg; ?>" readonly />
                                </div>
                            </div>
                            <br><br>
                            <div class="row">
