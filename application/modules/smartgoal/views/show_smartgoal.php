         ...
         <form action="<?php echo base_url()?>smartgoal/edit_smartgoal" method="post">
            ...
            <div class="performance-wrap">
                           ...
                           <tr>
                              ...
                              <td >
                                 ...
                                 <select class="form-control select" name="rating[<?php echo $key?>][]">
                                    ...
                                    <option value="1" <?php if($rating[0] == 1){echo"selected";} ?> >1</option>
                                    <option value="2" <?php if($rating[0] == 2){echo"selected";} ?>>2</option>
                                    <option value="3" <?php if($rating[0] == 3){echo"selected";} ?>>3</option>
                                    <option value="4" <?php if($rating[0] == 4){echo"selected";} ?> >4</option>
                                    <option value="5" <?php if($rating[0] == 5){echo"selected";} ?> >5</option>
                                 </select>
                              </td>
                              ...
                              <td class="text-center">
                                  <div class="">
                                    <input type="text" class="form-control score" value='<?php echo $score;?>' name="score[]" id="score">
                                  </div>
                              </td>
                              <?php } ?>
                           </tr>
               ...
               <?php if($this->session->userdata("user_type_name") !='employee'){?>
                  <div class="row"> 
                     <div class="col-md-12">
                        <input type="submit" name="manager_smart_goal_rating" class="btn btn-success">
                     </div>
                  </div>
               <?php } ?>
               <div>
