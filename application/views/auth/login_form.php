	...
	<div class="account-content">
		<div style="text-align-last: end;">
	    	<a href="<?php echo 'https://ai.automhr.com'?>" class="btn btn-primary text-uppercase">AI</a>
	    	<a href="<?=base_url()?>candidates/all_jobs_user" class="btn btn-primary text-uppercase">Career</a>
		</div>
