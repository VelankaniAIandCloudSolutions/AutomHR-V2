<div class="modal-dialog">
	<div class="modal-content">
		...
		<?php $attributes = array('class' => 'bs-example form-horizontal','id'=>'branchlisttable'); echo form_open_multipart(base_url().'all_branches/edit_branch/',$attributes); ?>
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<label class="switch">
							<input type="checkbox" name="geo_fencing" value="enable" <?php if($branch_details['geo_fencing'] == 'enable'){ echo 'checked';}?>>
...
<script>
  ...
  const map = new google.maps.Map(document.getElementById("map"), {
    center: { lat: <?php echo $branch_details['lattiude']; ?>, lng: <?php echo $branch_details['longtitude']; ?> },
    zoom: 13,
  ...
  if(searchBox){
	const position = { lat: <?php echo $branch_details['lattiude']; ?>, lng: <?php echo $branch_details['longtitude']; ?> };
