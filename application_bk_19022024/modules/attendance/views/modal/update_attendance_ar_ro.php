									...
									<div class="col-md-6">
										<div class="card recent-activity">
											<div class="card-body">
												...
												<form method="post" action="<?php echo base_url();?>attendance/update_attendance_ar_ro/<?php echo $user_id;?>/<?php echo $atten_day;?>/<?php echo $atten_month;?>/<?php echo $atten_year;?>">
