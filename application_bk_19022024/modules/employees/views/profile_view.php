											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<select class="form-control" name="payment_type" id="payment_type">
														...
														<option value="manual bank transfer" <?php if($bank_statutories['payment_type'] == 'manual bank transfer'){ echo "selected"; } ?>><?php echo 'Manual Bank Transfer'?></option>
													</select>
											   </div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" class="form-control PFrecords EMprate" name="pf_add_rates" id="pf_add_rates" placeholder="Rates(%)" value="<?php echo $in_bank_statutories->pf_add_rates; ?>" <?php if($in_bank_statutories->pf_contribution == 'no'){ echo "disabled"; } ?>>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-group">
										...
										<?php 
											...
											if(is_array($payroll_addition))
											{
												...
												{ ?>
													...
													<th>
														<input type="number" class="form-control" name="<?php echo $value['addtion_name'];?>" 
														value="<?php echo $value['unit_amount']; ?>" pattern="[0-9]*">
													</th>
												</tr>
											<?php $i++; } } ?>
										</tbody>
										...
										<?php $all_addtional = $this->db->get_where('bank_statutory',array('user_id'=>$employee_details['user_id']))->row_array(); 
											...
											if(is_array($payroll_deduction))
											{
												...
												{ ?>
													...
													<th>
														<input type="number" class="form-control" name="<?php echo $value['model_name'];?>" 
														value="<?php echo $value['unit_amount']; ?>" pattern="[0-9]*">
													</th>
												</tr>
											<?php $i++; } } ?>
										...
										if(!empty($all_file_attachments)){
											foreach($all_file_attachments as $attachment){ 
												...
												<tr>
													...
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<a href="<?php echo base_url().'employees/delete_file_attachment/'.$attachment['user_file_id'];?>" onclick="return confirm('Are you want to delete?')">Delete</a></td>
												</tr>
											<?php 	
												$re++;
											}
									...
									<div class="row">
										...
										<div class="col-sm-6">
											...
											<select class="form-control" style="width:100%;" name="designations" id="designations" <?php echo ($this->session->userdata('user_id') == $employee_details['user_id'])?"disabled":"";?>>
												...
												?>
														<option value="<?php echo $designation_1['id']?$designation_1['id']:'';?>" <?php if($employee_details['designation_id'] == $designation_1['id']){echo 'selected';}?> ><?php echo $designation_1['designation']?$designation_1['designation']:'Select';?></option>
													<?php }
												}?>
												</select>
												<?php }?>
										...
										<div class="col-sm-6">
											...
											<select class="form-control" style="width:100%;" name="is_reporter" id="is_reporter">
												...
												<option value="no" <?php echo($employee_details['is_reporter']=='no') ? 'selected' : ''; ?> >No</option>
												</select>
											...
											?>
												<div class="form-group">
													...
													<?php if($this->session->userdata('user_id') != $employee_details['user_id']){?>
														...
														?>
																<option value="<?php echo $user_1['user_id']?$user_1['user_id']:'';?>" <?php if($employee_details['teamlead_id'] == $user_1['user_id']){echo 'selected';}?> ><?php echo $user_1['fullname']?$user_1['fullname']:'Select';?></option>
															<?php }
														}?>
														</select>
													<?php }else{
...
<script type="text/javascript">
	...
	function edit_file_attachment(a){
		...
		$.ajax({url: "<?php echo base_url(); ?>employees/get_file_attachment/"+a, success: function(result){
			var obj = JSON.parse(result);
