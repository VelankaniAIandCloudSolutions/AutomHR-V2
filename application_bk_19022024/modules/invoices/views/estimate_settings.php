...
<div class="page-header">
	<div class="row">
		<div class="col-12">
			<h3 class="page-title p-5"><?=lang('estimate_settings')?></h3>
			<ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?=base_url()?>"><?=lang('dashboard')?></a></li>
                <li class="breadcrumb-item active"><?=lang('estimate_settings')?></li>
            </ul>
		</div>
...
<div class="p-0">
	...
	<div class="col-lg-12 p-0">
		...
		echo form_open_multipart('invoices/update', $attributes); ?>
			<div class="card panel-white">
				...
				<div class="card-body">
					...
					<div class="form-group terms form-row">
