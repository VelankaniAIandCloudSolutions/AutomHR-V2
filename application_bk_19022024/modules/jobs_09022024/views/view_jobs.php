...
<div class="content">
	...
	<div class="row">
		<div class="col-8">
			<h4 class="page-title m-b-0"><?php echo lang('view_jobs');?></h4>
			<ul class="breadcrumb p-l-0" style="background:none; border:none;">
		        ...
		        <li class="breadcrumb-item"><?php echo lang('view_jobs');?></li>
			</ul>
		</div>
	...
	<div class="row">
		<div class="col-md-8">
			<div class="job-info job-widget">
				...
				<h3 class="job-title text-capitalize mt-2"><?php echo $jobs_detail['job_title']; ?></h3>
				...
				<ul class="job-post-det">
					...
					<li><i class="fa fa-user-o"></i> <?php echo lang('applications');?>: <span class="text-blue"><?php echo $applications['count']?></span></li>
					<li><i class="fa fa-eye"></i> <?php echo lang('views');?>: <span class="text-blue"><?php  echo $total_views['count'];?></span></li>
				</ul>
			</div>
		...
		<div class="col-md-4">
			<div class="job-det-info job-widget">
				<a class="btn job-btn" href="<?php echo base_url(); ?>jobs/edit/<?php echo $jobs_detail['id']; ?>"><?php echo lang('edit'); ?></a>
				<div class="info-list">
