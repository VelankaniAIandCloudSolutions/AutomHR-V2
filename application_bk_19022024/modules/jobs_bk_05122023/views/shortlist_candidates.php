						...
						<td class="text-center">
							<div class="dropdown action-label">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<?php /*<a class="dropdown-item" href="<?php echo site_url('jobs/user_status_change/7/'.$list->candidate_id.'/'.$list->id.'/shortlist_candidates');?>"><i class="fa fa-dot-circle-o text-success"></i>  <?php echo lang("offered"); ?></a>*/?>
									<a class="dropdown-item" href="<?php echo site_url('offers/create_offer/'.$list->candidate_id.'/'.$list->id);?>"><i class="fa fa-dot-circle-o text-success"></i>  <?php echo lang("offered"); ?></a>
								</div> 
								<?php }?>
							</div>
						</td>
