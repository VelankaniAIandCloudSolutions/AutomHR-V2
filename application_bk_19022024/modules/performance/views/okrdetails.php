									...
									<div class="table-responsive">
										...
										<table class="table performance-table">
											...
											<tbody>
												...
												if($obj->key_status == "Approved")  
												{
													$btn_pending = 'btn-success';
												}
												elseif($obj->key_status == "Pending")
												{
												...
												<td>
													...
													<td class="text-center">													   <button type="button" class="btn btn-success obj_feedback" onclick="objective_feedback(<?php echo $key?>)" data-id="<?php echo $key ?>"><i class="fa fa-comment"></i></button>
											...
											<tbody id="key_result_container">
												<tr>
													...
													<td class="text-center">
														<div class="dropdown">
															<span class="badge <?=$btn_pending?>" name="okr_status[]"><?php echo $obj->key_status ?></span>
													...
													<td class="text-center">
														...
														<select class="form-control select" name="key_gradeval[]" >
															...
															for ($i=0; $i <count($rating_no) ; $i++) {
																if(!empty($rating_no[$i])){
															  ?>
															<option value="<?php echo $rating_no[$i];?>" <?php echo ($obj->keyprog_value == $rating_no[$i])?"selected":"";?>><?php echo $rating_value[$i];?></option>
														<?php } } } else { ?>
																<option value="">Ratings Not Found</option>
														<?php } ?>
													...
													<td class="text-center">
														 <button type="button" class="btn btn-white key_feedback" onclick="key_feedback(<?php echo $key?>)" data-id="<?php echo $key ?>"><i class="fa fa-comment"></i></button>
													</td>
												</tr>
												<?php } ?>
											</tbody>
						...
						<form>
							<div class="form-group">
								...
								<?php 
					        		...
					        		{    
					        	?>
								<textarea rows="4" class="form-control objec_feedback" name="obj_feedback[]" id="feedback_obj_<?php echo $key?>" readonly><?php echo $obj->obj_feedback?></textarea>

								<textarea rows="4" class="form-control key_feedback_textarea" name="key_feedback[]" id="key_feedback_<?php echo $key?>" readonly><?php echo $obj->key_feedback?></textarea>
							<?php } ?>
							</div>
