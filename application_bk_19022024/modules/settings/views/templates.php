...
switch ($template_group) {
    ...
    case "attendance_regularization": $default = "attendance_regularization"; break;
    case "attendance_regularization_approve": $default = "attendance_regularization_approve"; break;
    case "offer_send": $default = "offer_send"; break;
    case "birthday": $default = "birthday"; break;
    case "anniversary": $default = "anniversary"; break;
}
            ...
            <div class="panel panel-white">
                ...
                <div class="panel-body">
					<ul class="nav nav-tabs nav-tabs-solid m-b-20">
						...
						switch($temp) {
							...
							case "attendance_regularization": $lang = "attendance_regularization"; break;
							case "attendance_regularization_approve": $lang = "attendance_regularization_approve"; break;
							case "offer_send": $lang = "offer_send"; break;
							case "birthday": $lang = "birthday"; break;
                            case "anniversary": $lang = "anniversary"; break;
						} ?>
                ...
                <?php endif; ?>
                    ...
                    <div class="form-group">
						...
						<div class="col-lg-12">
							<textarea class="form-control foeditor-550" name="email_template" id="email_template"><?php echo App::email_template($setting_email,'template_body');?></textarea>
						</div>
                    </div>
                    <?php if ($template_group === 'offer_send') : ?>
                    <div class="form-group">
