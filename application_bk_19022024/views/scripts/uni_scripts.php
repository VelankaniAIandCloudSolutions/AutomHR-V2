         ...
         bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    ...
                    dataType:'json',
                    type: 'POST',
                    data: {'assoc_id':ascid,'ch_asso_id_img':ch_asso_id_img},
                    success: function (data) {
...
//Bootbox prompt for 
         ...
         bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    ...
                    dataType:'json',
                    type: 'POST',
                    data: {'job_id':job_id,'can_id':can_id,'ch_asso_id_img':ch_asso_id_img},
                    success: function (data) {
		...
		function send_sign_preview(job_id,can_id,sign){
			$.ajax({
                    ...
                    dataType:'json',
                    type: 'POST',
                    data: {'job_id':job_id,'can_id':can_id,'sign':sign},
                    success: function (data) {
                        if(data.response=='ok')
                        {
							$('#digital_signature_div').modal('hide');
